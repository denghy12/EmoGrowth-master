...
class DistributionBalancedLoss(nn.Module):
    def __init__(
        ...
        init_bias_tensor = -torch.log(num_samples_tensor / class_freq - 1.0).clamp(min=-20.0, max=20.0)
        init_bias_tensor = init_bias_tensor * self.init_bias_scale / self.neg_scale
