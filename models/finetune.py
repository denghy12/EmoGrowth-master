...
class Finetune(BaseLearner):
    def __init__(self, args):
        ...
        self.init_epoch = args.get("init_epoch", init_epoch)
        self.init_lr = args.get("init_lr", init_lr)
        self.init_milestones = args.get("init_milestones", init_milestones)
        self.init_lr_decay = args.get("init_lr_decay", init_lr_decay)
        ...
        self.milestones = args.get("milestones", milestones)
        self.lrate_decay = args.get("lrate_decay", lrate_decay)
